     ...
     <section class="py-20 bg-gray-50 dark:bg-gray-900" id="projects">
      <div class="container mx-auto px-6">
        <div class="text-center mb-16">
          <h2 class="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">Meus <span class="text-blue-600 dark:text-blue-400">Projetos</span></h2>
  ...
  projects: Project[] = [
    {
      ...
      description: "Projeto importante e muito significativo para as empresas, em fase de desenvolvimento.",
      image: "https://www.mspa.com.br/wp-content/uploads/2023/03/MSPA-Logo-horizontal-300dpi.jpg",
    ...
    },
    {
      ...
      description: "Este projeto é um sistema de gerenciamento financeiro que permite cadastrar pessoas e registrar suas transações financeiras (receitas e despesas).",
      image: "https://www.pngall.com/wp-content/uploads/2016/06/Finance-Free-PNG-Image.png",
    ...
    },
    {
      ...
      description: "O DoTask é o gerenciador de tarefas ideal, unindo simplicidade e eficiência.",
      image: "https://static.vecteezy.com/system/resources/previews/002/531/057/large_2x/task-list-illustration-vector.jpg",
    ...
    },
    {
      ...
      description: "Projeto de análise de dados designado para analisar vendas e sale perfomance.",
      image: "https://www.itexchangeweb.com/blog/wp-content/uploads/2016/01/85_YW5hbHlzaXM.jpg",
    ...
    },
    {
      ...
      image: "https://th.bing.com/th/id/OIP.xxecBuEe_1m4IxOxrp4pBAAAAA?rs=1&pid=ImgDetMain",
    ...
    },
    {
      id: 6,
      title: "AndPlayer",
      description: "MP3 Player para músicas locais (armazenadas em pastas dentro do computador).",
      image: "https://cdn.pixabay.com/photo/2013/07/12/18/58/mp3-player-154090_640.png",
